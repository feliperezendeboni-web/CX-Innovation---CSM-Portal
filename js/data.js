window.dashboardData = {
    ...
    tacticalRoadmap: {
        headers: ["Tática / Ação", "Categoria", "Envolvimento", "Horas/Tokens Est.", "Mês Planejado", "Status"],
        columns: ["tactic", "category", "involvement", "estHours", "plannedMonth", "status"],
        rows: [
            { tactic: "Implementação de Resident Architect", category: "Arquitetura", involvement: "Alteryx", estHours: "40", plannedMonth: "Janeiro", status: "Em Andamento", archived: false },
            { tactic: "Sessões de Orientação (Onboarding)", category: "Enablement", involvement: "Ambos", estHours: "10", plannedMonth: "Fevereiro", status: "Planejado", archived: false },
            { tactic: "Avaliação de Governança (AGB)", category: "Governança", involvement: "Cliente", estHours: "5", plannedMonth: "Março", status: "Planejado", archived: false }
        ]
    },
